...
public class RentalServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String VpickLocation = request.getParameter("pick-location");
		String VdropLocation = request.getParameter("drop-location");
		...
		if (validate == DBUtil.validateLogin(Vusername, Vpassword)) {
			isTrue = DBUtil.insert(Vname, VpickLocation, VdropLocation, Vemail, Vphone, Vother);
