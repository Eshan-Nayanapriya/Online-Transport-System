...
<title>Update Ride Details Page</title>
...
<br>
<br>
	<h1 style="color: blue;">UPDATE RIDE DETAILS</h1>
	<form id="rentalForm" action="UpdateRentServlet" method="post">
		...
		<input type="text" id="uname"  autocomplete="off" placeholder="Eshan Nayanapriya"  value="${ rent.name}" name="uname" required> 
		<!--  -->
		<!--  -->
		<!--  -->
